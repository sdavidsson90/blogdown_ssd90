...
For my first few blog posts, I will be working with a dataset describing bike crashes in North Carolina. This very same dataset was also the one that I used for my final thesis studying Data Analytics at Dania Academy. 
...
The map also suggests that a majority of the crashes take place in urban areas, and less so in rural areas (Rural 28 % vs 72 % urban). This of course not an earth shaking insight, but it is certainly not an irrelevant point for further analysis. Here I am using data  from the United States Census Bureau [aquired via tidycensus](https://github.com/sdavidsson90/bike_crash/blob/main/code/tidycensus.R) . Here's a map of the population size by county:
