...
For my first few blog posts, I plan on using this *bike crash*-dataset that I also used for my final thesis studying Data Analytics at Dania Academy. I have already done some [preprocessing](https://github.com/sdavidsson90/bike_crash/blob/main/code/data_preprocessing.R), and now I want to present some of the challanges and oppurtunities that present themselves in working with this dataset.
...
An important criterion for choosing a dataset to work with was to avoid being acused of plagiarizing. The dataset was posted on Kaggle, but no machine learning solutions had been posted. 
...
### **Initial visualisation of the data: *Where* do accidents occurr?**
