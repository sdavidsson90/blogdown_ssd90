...
We want to select the model that is best able to predict true positives (ie. has the highest sensitivity) but  retains an ability to predict true negatives. Otherwise we simply could've resorted to adjusting the threshold value of the first two models.

We also want to consider the accuracy and the ROC-AUC in our model selection. 
